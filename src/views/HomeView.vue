	...
	<main>
		<div id="landing" class="responsive-container sm:translate-y-0 ">
			<section class="flex sm:flex-row flex-col sm:justify-between justify-center">
				<div data-aos="fade-right" class="left-section cursor-default flex flex-col justify-center items-start md:w-2/3">
				...
				<div data-aos="fade-left" class="right-section sm:flex sm:w-1/3 hidden sm:h-screen justify-center items-center">
